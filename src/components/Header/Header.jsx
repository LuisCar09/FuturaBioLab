...
const Header = () => {
    ...
    const links = [{name:'Home',path:'/',id:crypto.randomUUID()},{name:'About us', path:'/aboutus',id:crypto.randomUUID()},{name:'Contact us',path:'/contactus',id:crypto.randomUUID()},{name:'Log in',path:'/login',id:crypto.randomUUID()},{name:'Projects',path:'/projects',id:crypto.randomUUID()}]
    const handleScroll = () => {
